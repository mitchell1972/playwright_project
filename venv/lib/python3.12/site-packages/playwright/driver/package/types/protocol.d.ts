...
using Audits.issueAdded event.
    ...
    export type checkContrastParameters = {
      /**
       * Whether to report.html WCAG AAA level issues. Default is false.
       */
      reportAAA?: boolean;
    }
...
on Android.
    ...
    export type setHardwareConcurrencyOverrideParameters = {
      /**
       * Hardware concurrency to report.html
       */
...
the same request (but not for redirected requests).
    ...
    /**
     * The status of a Reporting API report.html.
     */
    export type ReportStatus = "Queued"|"Pending"|"MarkedForRemoval"|"Success";
    export type ReportId = string;
    /**
     * An object representing a report.html generated by the Reporting API.
     */
    export interface ReportingApiReport {
      id: ReportId;
      /**
       * The URL of the document that triggered the report.html.
       */
      initiatorUrl: string;
      /**
       * The name of the endpoint group that should be used to deliver the report.html.
       */
      destination: string;
      /**
       * The type of the report.html (specifies the set of data that is contained in the report.html body).
       */
      type: string;
      /**
       * When the report.html was generated.
       */
      timestamp: Network.TimeSinceEpoch;
      /**
...
after webbundle was parsed.
    ...
    /**
     * Is sent whenever a new report.html is added.
...
https://html.spec.whatwg.org/multipage/system-state.html#rph-automation
    ...
    /**
     * Generates a report.html for testing.
     */
    export type generateTestReportParameters = {
      /**
       * Message to be displayed in the report.html.
       */
      message: string;
      /**
       * Specifies the endpoint group to deliver the report.html to.
       */
      group?: string;
    }
...
See also: timelineEventAdded
    ...
    export type enableParameters = {
      /**
       * The types of event to report.html, as specified in
...
buffer wrapped around.
    ...
    export type startParameters = {
      ...
      /**
       * Whether to report.html trace events as series of dataCollected events or to save trace to a
