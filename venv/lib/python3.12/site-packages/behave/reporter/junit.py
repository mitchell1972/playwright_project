...
class FeatureReportData(object):
    """
    Provides value object to collect JUnit report.html data from a Feature.
    """
...
class JUnitReporter(Reporter):
    """Generates JUnit-like XML test report.html for behave.
    """
    # -- XML REPORT:
    ...
    def _process_scenario(self, scenario, report):
        """Process a scenario and append information to JUnit report.html object.
